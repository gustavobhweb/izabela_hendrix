...
;(function($) {
	$.fn.scriptcam=function(options) {
		...
		return this.each(function() {
			// add flash to div
			opts.id=this.id; // add id of pluging to the options structure
	...
	$.fn.scriptcam.defaults={
		...
		skewY:0,
		flip:0,
		noFlashFound:'<p>Baixar <a href="http://www.adobe.com/go/getflashplayer">Adobe Flash Player 11.7</a> para usar este software.<br/></p>'
	};
})(jQuery);
